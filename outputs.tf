...
output "scaleway_k8s_cluster_beta_config_file" {
  value = scaleway_k8s_cluster_beta.this.config_file
}

output "scaleway_k8s_cluster_beta_host" {
  value = scaleway_k8s_cluster_beta.this.host
}

output "scaleway_k8s_cluster_beta_cluster_ca_certificate" {
  value = scaleway_k8s_cluster_beta.this.cluster_ca_certificate
}

output "scaleway_k8s_cluster_beta_token" {
  value = scaleway_k8s_cluster_beta.this.token
}
